    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
           ...
           // string path = Menu.getMap(8);
            ...
            bool change = false;
            Thread player = new Thread(() => ThreadProcClass.ThreadProcPlayer(ref p, ref mutex, ref change, ref mlist, ref ownedKeys, ref keys, ref doors, ref coins,ref exit ,ref writer));
            player.Start();
